<!DOCTYPE html>
<html class="loading" lang="{{ LaravelLocalization::getCurrentLocaleDirection() }}" data-textdirection="{{app() -> getLocale() == 'ar' ? 'rtl' : 'ltr' }}" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}">
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dist/min/dropzone.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/plugins/file-uploaders/dropzone.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
