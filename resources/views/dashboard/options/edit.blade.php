                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.options')}}"> القيم</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل قيمة </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.options.update', $option-> id)}}"
                                              method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="product_id" class="form-control select2" style="width: 100%">
                                                                <optgroup label="الخصائص">
                                                                    ...
                                                                    <option value="{{$product -> id}}" {{$product -> id == $option -> product_id ? 'selected' : ''}}>{{$product -> name}}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
