            ...
            <div class="content-body">
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{__('dashboard.products_num')}}</h4>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h4>$9,980</h4>
                                        </div>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{__('dashboard.clients_num')}}</h4>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h4>2000</h4>
                                        </div>
                ...
                <div class="row match-height">
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('dashboard.lastes_order')}}</h4>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('dashboard.lastes_review')}}</h4>
                                <div class="heading-elements">
                                </div>
                            </div>
                            <div class="card-content">
