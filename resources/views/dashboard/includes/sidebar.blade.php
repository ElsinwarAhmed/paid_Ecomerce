<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">{{__('dashboard.settings')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('dashboard.delivery_means')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.settings.editShipping', 'free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('dashboard.free_delivery')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.settings.editShipping', 'locale')}}">{{__('dashboard.locale_delivery')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.settings.editShipping', 'outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('dashboard.outer_delivery')}}</a>
                            </li>
